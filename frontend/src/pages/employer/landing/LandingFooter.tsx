...
const FOOTER_COLUMNS = {
  "Về AI Job Portal": [
    ...
    { label: "Hệ sinh thái HR Tech", href: "#about" },
    { label: "Tuyển dụng nội bộ", href: "#" },
    { label: "Liên hệ truyền thông", href: "#contact" },
    { label: "Góc báo chí", href: "#partners" },
  ],
  "Dành cho Nhà tuyển dụng": [
    { label: "Đăng tin tuyển dụng", href: "#services" },
    { label: "Tìm kiếm hồ sơ CV", href: "#services" },
    { label: "Gói dịch vụ Top Max", href: "#services" },
    { label: "Báo giá giải pháp", href: "#pricing" },
    { label: "Cẩm nang tuyển dụng", href: "#" },
  ],
  "Dành cho Ứng viên": [
    { label: "Mẫu CV xin việc chuẩn", href: "#" },
    { label: "Tìm việc làm nhanh", href: "#" },
    { label: "Tính lương Gross - Net", href: "#" },
    { label: "Trắc nghiệm MBTI", href: "#" },
    { label: "Cẩm nang nghề nghiệp", href: "#" },
  ],
  "Chính sách & Quy định": [
    { label: "Quy định bảo mật", href: "#" },
