...
INDUSTRY_KEYWORDS: dict[str, list[str]] = {
    "IT - Phần mềm": [
        ...
        "fastapi", "django", "flask", "sql", "database", "api", "backend",
        "frontend", "fullstack", "devops", "docker", "kubernetes", "cloud",
        "ai", "machine learning", "deep learning", "typescript", "golang",
        "c++", "c#", ".net", "aws", "gcp", "azure", "git", "cicd",
        "microservices", "rest", "graphql", "linux", "agile", "scrum",
    ],
    "Marketing": [
        "marketing", "seo", "sem", "content", "social media", "facebook ads",
        "google ads", "email marketing", "branding", "pr", "digital",
        "campaign", "analytics", "kol", "influencer", "copywriting",
    ],
    "Kế toán": [
        "kế toán", "thuế", "tax", "sap", "excel", "báo cáo tài chính",
        "hóa đơn", "sổ sách", "audit", "kiểm toán", "ngân hàng", "tín dụng",
        "finance", "accounting", "bookkeeping", "payroll",
    ],
    "Kinh doanh": [
        "kinh doanh", "sales", "bán hàng", "khách hàng", "doanh số",
        "revenue", "b2b", "b2c", "account manager", "business development",
        "partnership", "kpi", "target", "negotiation", "crm",
    ],
    "Thiết kế": [
        "photoshop", "illustrator", "figma", "sketch", "adobe", "ui", "ux",
        "thiết kế", "design", "wireframe", "prototype", "graphic", "canva",
        "after effects", "premiere", "motion", "3d", "blender",
    ],
}
